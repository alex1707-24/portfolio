    ...
    <div class="col-10 mx-auto">     
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
                ...
                <div class="row">
                    ...
                    <div class="col-2 mt-2 px-0 text-center">
                        <h5><?php echo $pizza["prici"] ?>  <span>₽</span></h5>                        
                    </div>
        ...
        <div class="row  pb-5">
            <?php 
                ...
                $query = mysqli_query($connect,'SELECT * FROM rizza');   
            ?>
            <?php while ($pizza = $query -> fetch_assoc()) { ?>
            <div class="col-3">   
                <img src="<?php echo $pizza["img"] ?>" class="w-100">
                <div class="pizz"> 
                    <h3><?php echo $pizza["name"] ?></h3>   
                    <p class="text-secondary"><?php echo $pizza["ingredients"] ?></p>
                </div>  
                <div class="row">
                    <div class="col-6">
                        <h3><?php echo $pizza["prici"] ?> <span>₽</span></h3>                        
                    </div>
                    <div class="col-6">
