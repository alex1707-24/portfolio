...
<body>
	...
	<div class="container">
		<h3>Вся женская обувь с размером больше 36:</h3>
		<?php $con = mysqli_connect('MySQL-8.2', 'root', '', 'zadanue'); 
		$query = mysqli_query($con, "SELECT * FROM products WHERE gender = 'женский'AND size > 36 AND category = 'обувь'	");
